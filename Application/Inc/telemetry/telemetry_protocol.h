...
enum DatagramPayloadType {
	ORDER_PACKET = 0x09, IGNITION_PACKET = 0x07, GSE_STATE_PACKET = 0x0A, ECHO_PACKET = 0x0B
};

enum  packetSize
{
	ORDER_PACKET_SIZE = 30, IGNITION_PACKET_SIZE = 31
};
...
#define TOTAL_DATAGRAM_OVERHEAD (DATAGRAM_ID_SIZE + PREFIXE_EPFL_SIZE + TIMESTAMP_SIZE + SEQ_NUMBER_SIZE + CHECKSUM_SIZE)
...
#define GSE_STATE_DATAGRAM_PAYLOAD_SIZE 54
#define ORDER_DATAGRAM_PAYLOAD_SIZE 1
#define ECHO_DATAGRAM_PAYLOAD_SIZE 1
#define IGNITION_DATAGRAM_PAYLOAD_SIZE 2
